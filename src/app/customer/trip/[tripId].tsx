...
const TripDetailsScreen = () => {
  ...
  const {
    ...
    queryKey: ["TripDetailsForCustomer",tripId],
  ...
  const renderActionButton = () => {
    ...
    if (tripsDetailsData?.customer_loading_confirmed === 0 && tripsDetailsData?.status !== "completed") {
      return (
        <TouchableOpacity
          className="bg-[#394F91] rounded-2xl p-4 mt-6"
          onPress={() => handlePress(`/customer/trip/confirm-loading-point-details/${tripId}`)}
        >
      ...
      return (
        <TouchableOpacity
          className="bg-[#394F91] rounded-2xl p-4 mt-6"
          onPress={() => handlePress(`/customer/trip/confirm-offloading-point-details/${tripId}`)}
        >
          <Text className="text-white text-center font-semibold">
