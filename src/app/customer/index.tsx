      ...
      <ScrollView className="flex-1 bg-[#F9F9F9] ">
        ...
        <View className="mt-6 mb-8 mx-6">
          <View className="flex-row justify-between">
            ...
            <TouchableOpacity onPress={() => handlePress("/customer/vendors")}>
        ...
        <View className="mt-6 mb-8 mx-6">
          <View className="flex-row justify-between">
            ...
            <TouchableOpacity onPress={() => handlePress("/customer/drivers")}>
              <View className="flex flex-row items-center gap-1">
                <Text className="text-[#394F91] text-xs ">View All</Text>
                <ArrowRight />
              </View>
        ...
        <View className="mt-6 mx-6">
          <View className="flex-row justify-between">
            ...
            <TouchableOpacity onPress={() => handlePress("/customer/trucks")}>
              <View className="flex flex-row items-center gap-1">
                <Text className="text-[#394F91] text-xs ">View All</Text>
                <ArrowRight />
              </View>
